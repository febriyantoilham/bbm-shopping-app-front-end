...
class Dimensions {
  ...
  static double statusBarWidth = Get.context!.mediaQueryViewPadding.top;
  ...
  static double height80 = screenHeight / (screenHeight / 80);
  ...
  static double width60 = screenHeight / (screenHeight / 60);
  static double width80 = screenHeight / (screenHeight / 80);
  ...
  static double productImgSize = screenHeight / 2.14;

  static double btmBarHeight = screenHeight / 4.45;
